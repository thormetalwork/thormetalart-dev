...
(function () {
    ...
    const STORAGE_KEY = 'tma_panel_lang';
    ...
    const dictionaries = {
        es: {
            ...
            'google.step4.items':
                'Recibirás un email de confirmación|Google revisará la solicitud (1-3 días hábiles)|Cuando aprueben, recibirás otro email|Avísanos para activar la integración',
        ...
        en: {
            ...
            'google.step4.items':
                'You will receive a confirmation email|Google will review the request (1-3 business days)|When approved, you will receive another email|Let us know to activate the integration',
