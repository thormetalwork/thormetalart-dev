---
description: "Create a new WordPress page with bilingual content, SEO meta tags, and proper branding for Thor Metal Art"
argument-hint: "Page name and description (e.g., Custom Metal Gates - Service page for gate products)"
agent: "wordpress-dev"
---
Create a new WordPress page for Thor Metal Art:
